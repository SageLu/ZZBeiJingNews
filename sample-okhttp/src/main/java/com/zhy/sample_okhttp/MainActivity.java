...
public class MainActivity extends AppCompatActivity {
    ...
    public void getHtml(View view) {
        ...
        url = "http://192.168.1.111:8080/web_home/static/api/news/categories.json";
        OkHttpUtils
                .get()
                .url(url)
                .id(100)
...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void uploadFile(View view) {
        ...
        String url = "http://192.168.1.111:8080/FileUpload/FileUploadServlet";
    ...
    public void multiFileUpload(View view) {
        ...
        File file3 = new File(Environment.getExternalStorageDirectory(), "bangbang.mp4");
        if (!file.exists()) {
            Toast.makeText(MainActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        String url = "http://192.168.1.111:8080/FileUpload/FileUploadServlet";
        OkHttpUtils.post()//
                .addFile("mFile", "zz.jpg", file)//
                .addFile("mFile", "zz.txt", file2)//
                .addFile("mFile", "bangbang.mp4", file3)//
                .url(url)
                .params(params)//
                .build()//
                .execute(new MyStringCallback());
    ...
    public void downloadFile(View view) {
        String url = "https://github.com/hongyangAndroid/okhttp-utils/blob/master/okhttputils-2_4_1.jar?raw=true";
         url = "http://192.168.1.111:8080/ifyou.mp4";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "ifyou.mp4")//
                {
                    ...
                    public void onResponse(File file, int id) {
                        ...
                        Log.e(TAG, "zz-Environment.getExternalStorageDirectory() :" + Environment.getExternalStorageDirectory());
