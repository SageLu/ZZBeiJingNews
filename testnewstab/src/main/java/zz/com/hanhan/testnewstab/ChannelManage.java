...
public class ChannelManage {
    ...
    public List<ChannelItem> getUserChannel() {
        ...
        Log.d("zhang","cacheList != null"+(cacheList != null));
        Log.d("zhang","(List<?>) cacheList).isEmpty()"+((List<?>) cacheList).isEmpty());
        Log.d("zhang","(List<?>) cacheList).isEmpty()"+((List<?>) cacheList).toString());
